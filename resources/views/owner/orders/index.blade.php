    ...
    <table class="w-full border border-gray-300 rounded-lg overflow-hidden text-left">
        <thead class="bg-orange-100 text-orange-800 font-semibold">
            <tr>
                ...
                <th class="p-3 border-b border-orange-300"> Customer</th>
                <th class="p-3 border-b border-orange-300"> Delivery Address</Address></th>
        ...
        <tbody>
            ...
            <tr id="display_row_{{ $order->id }}" class="hover:bg-orange-50">
                ...
                <td class="p-3 border-b border-gray-200">{{ $order->customer_email }}</td>
