...
<section class="bg-[#FFEEDC] py-12 px-4">
 ...
 <!-- Partner With Us Section -->
  ...
  <!-- Form Popup Modal -->
  <div id="formModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
  ...
  <!-- Confirmation Popup -->
  <div id="confirmationPopup" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
